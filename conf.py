...
BLOG_AUTHOR = "porfirio"  # (translatable)
...
BLOG_EMAIL = "porfiriopaiz@gmail.com"
BLOG_DESCRIPTION = "floss, gis, ajedrez y más..."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "porfiriopaizblog"
